...
class ConnectivityCheckerTest {
    ...
    private fun setupCapabilities(hasInternet: Boolean, isValidated: Boolean) {
    ...
    fun `WHEN internet is available AND validated SHOULD return true`() {
        // GIVEN
        setupNetwork()
        setupCapabilities(hasInternet = true, isValidated = true)
    ...
    fun `WHEN no active network SHOULD return false`() {
        // GIVEN
        setupNetwork(activeNetwork = null)
    ...
    fun `WHEN network capabilities are null SHOULD return false`() {
        // GIVEN
        setupNetwork(capabilities = null)
    ...
    fun `WHEN internet capability is missing SHOULD return false`() {
        // GIVEN
        setupNetwork()
        setupCapabilities(hasInternet = false, isValidated = true)
    ...
    fun `WHEN validated capability is missing SHOULD return false`() {
        // GIVEN
        setupNetwork()
        setupCapabilities(hasInternet = true, isValidated = false)
